...
SQL is vertically scalable but more expensive, and relational databses usually aren't structured

2. Why do tables need a `primary key`?

Because a primary key ensures row-level accessibility
...
You would use a joining table, which is basically a table that sits in between the two tables you are trying to connect
